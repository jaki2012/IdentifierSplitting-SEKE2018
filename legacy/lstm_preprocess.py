...
BT11_EXPERI_RESULT_FILE = "tmp/mixed_jhotdraw_experi_result.csv"
...
cf.read('config.ini')
processing_project = "final_training_data"
...
total_dict_list1 = list(itertools.chain.from_iterable(total_dict))
...
def word2vec(total_dict_list, dict_way=False):
	...
	if dict_way:
		...
		word_ids = coding(total_dict_list, char2id)
