...
hardsplit_binkley_result_csv = open(hs_oracle_samples_file, 'w', newline='')
csvwriter = csv.writer(hardsplit_binkley_result_csv)

non_hardsplit_binkley_result_csv = open(nhs_oracle_samples_file, 'w', newline='')
csvwriter2 = csv.writer(non_hardsplit_binkley_result_csv)
